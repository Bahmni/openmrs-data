create procedure bahmni_create_patient(_firstName varchar(50), _lastName varchar(50))
begin
	...
	insert into idgen_log_entry (source, identifier, date_generated, generated_by, comment) values (1, concat('GAN', _newId), _now, 1, 'Bahmni Registration App');
	...
	insert into patient_identifier (uuid, patient_id, identifier, identifier_type, location_id, date_created, date_voided, preferred, voided, void_reason, creator, voided_by, changed_by, date_changed) values (uuid(), _personId, concat('GAN', _newId), 3, null, _now, null, 1, 0, null, 1, null, 1, _now);
